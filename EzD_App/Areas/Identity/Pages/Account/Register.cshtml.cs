...
namespace EzD_App.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        IUserManager _userMng; //My addition
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Adding connection to User Model///////////////////////////////////////////////////////////////////
                    UserDto userDTO = new UserDto();
                    userDTO.FirstName = Input.FirstName;
                    userDTO.LastName = Input.LastName;
                    userDTO.IdentityUser = user;
                    _userMng.AddUserIdentity(userDTO);
